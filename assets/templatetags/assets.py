...
from assets.helpers.static_files import calculate_integrity_hash

logger = logging.getLogger(__name__)


@register.simple_tag
def assets_static(relative_file_path: str, script_type: str = None) -> str | None:
    """
    Versioned static URL

    :param relative_file_path: The file path relative to the `aa-assets/assets/static/assets` folder
    ...
    static_file_path = os.path.join("assets", relative_file_path)
